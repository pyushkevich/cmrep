#ifndef IPOPTQCQPPROBLEMINTERFACE_H
#define IPOPTQCQPPROBLEMINTERFACE_H
...
class IPOptQCQPProblemInterface : public Ipopt::TNLP
{
public:
  IPOptQCQPProblemInterface(qcqp::Problem &qp);
