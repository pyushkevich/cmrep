...
IF(IPOPT_LIBRARY)
  ...
  IF(IPOPT_BLAS_LIB AND IPOPT_LAPACK_LIB AND IPOPT_GFORTRAN_LIB)
    SET(IPOPT_LAPACK_LIBS ${IPOPT_LAPACK_LIB} ${IPOPT_BLAS_LIB} ${IPOPT_GFORTRAN_LIB})
    SET(IPOPT_LAPACK_FOUND 1 CACHE INTERNAL "Lapack is available from IpOpt")
  ELSE(IPOPT_BLAS_LIB AND IPOPT_LAPACK_LIB AND IPOPT_GFORTRAN_LIB)
    MESSAGE(SEND_ERROR "One of the IPOPT BLAS, LAPACK or GFORTRAN libs is not found")
  ENDIF(IPOPT_BLAS_LIB AND IPOPT_LAPACK_LIB AND IPOPT_GFORTRAN_LIB)
