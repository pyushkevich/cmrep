/* toms611.f -- translated by f2c (version 20050501).
...
#define model1 ((real *)&equiv_377)

    static struct {
	char e_1[24];
	real e_2;
	} equiv_378 = { " g   s  g-s s-g -s-g-g-s", 0.f };

#define model2 ((real *)&equiv_378)
    ...
    /* Fortran I/O blocks */
    static cilist io___339 = { 0, 0, 0, fmt_30, 0 };
    static cilist io___340 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___342 = { 0, 0, 0, fmt_100, 0 };
    static cilist io___343 = { 0, 0, 0, fmt_110, 0 };
    static cilist io___344 = { 0, 0, 0, fmt_70, 0 };
    static cilist io___345 = { 0, 0, 0, fmt_80, 0 };
    static cilist io___347 = { 0, 0, 0, fmt_100, 0 };
    static cilist io___348 = { 0, 0, 0, fmt_110, 0 };
    static cilist io___349 = { 0, 0, 0, fmt_140, 0 };
    static cilist io___350 = { 0, 0, 0, fmt_160, 0 };
    static cilist io___351 = { 0, 0, 0, fmt_180, 0 };
    static cilist io___352 = { 0, 0, 0, fmt_200, 0 };
    static cilist io___353 = { 0, 0, 0, fmt_220, 0 };
    static cilist io___354 = { 0, 0, 0, fmt_240, 0 };
    static cilist io___355 = { 0, 0, 0, fmt_260, 0 };
    static cilist io___356 = { 0, 0, 0, fmt_280, 0 };
    static cilist io___357 = { 0, 0, 0, fmt_300, 0 };
    static cilist io___358 = { 0, 0, 0, fmt_320, 0 };
    static cilist io___359 = { 0, 0, 0, fmt_340, 0 };
    static cilist io___360 = { 0, 0, 0, fmt_360, 0 };
    static cilist io___361 = { 0, 0, 0, fmt_380, 0 };
    static cilist io___362 = { 0, 0, 0, fmt_400, 0 };
    static cilist io___364 = { 0, 0, 0, fmt_30, 0 };
    static cilist io___365 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___366 = { 0, 0, 0, fmt_70, 0 };
    static cilist io___367 = { 0, 0, 0, fmt_80, 0 };
    static cilist io___368 = { 0, 0, 0, fmt_410, 0 };
    static cilist io___369 = { 0, 0, 0, fmt_420, 0 };
    static cilist io___371 = { 0, 0, 0, fmt_450, 0 };
    static cilist io___372 = { 0, 0, 0, fmt_460, 0 };
    static cilist io___373 = { 0, 0, 0, fmt_470, 0 };
    static cilist io___374 = { 0, 0, 0, fmt_490, 0 };
    static cilist io___375 = { 0, 0, 0, fmt_510, 0 };
    static cilist io___376 = { 0, 0, 0, fmt_530, 0 };
	...
	integer *liv, integer *lv, integer *n, doublereal *v)
{
	...
	char e_1[272];
	real e_2;
	} equiv_456 = { "epslon..phmnfc..phmxfc..decfac..incfac..rdfcmn..rdf"
		"cmx..tuner1..tuner2..tuner3..tuner4..tuner5..afctol..rfctol."
		".xctol...xftol...lmax0...lmaxs...sctol...dinit...dtinit..d0i"
		"nit..dfac....dltfdc..dltfdj..delta0..fuzz....rlimit..cosmin."
		".huberc..rsptol..sigmin..eta0....bias....", 0.f };

#define vn ((real *)&equiv_456)
...
#define varnm ((integer *)&equiv_457)
...
#define sh ((integer *)&equiv_458)

    static struct {
	char e_1[12];
	real e_2;
	} equiv_459 = { "---changed v", 0.f };

#define cngd ((real *)&equiv_459)

    static struct {
	char e_1[12];
	real e_2;
	} equiv_460 = { "nondefault v", 0.f };

#define dflt ((real *)&equiv_460)
    ...
    /* Fortran I/O blocks */
    static cilist io___431 = { 0, 0, 0, fmt_20, 0 };
    static cilist io___432 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___435 = { 0, 0, 0, fmt_70, 0 };
    static cilist io___436 = { 0, 0, 0, fmt_90, 0 };
    static cilist io___443 = { 0, 0, 0, fmt_130, 0 };
    static cilist io___444 = { 0, 0, 0, fmt_160, 0 };
    static cilist io___445 = { 0, 0, 0, fmt_180, 0 };
    static cilist io___446 = { 0, 0, 0, fmt_220, 0 };
    static cilist io___447 = { 0, 0, 0, fmt_260, 0 };
    static cilist io___448 = { 0, 0, 0, fmt_240, 0 };
    static cilist io___450 = { 0, 0, 0, fmt_260, 0 };
    static cilist io___451 = { 0, 0, 0, fmt_270, 0 };
    static cilist io___453 = { 0, 0, 0, fmt_310, 0 };
    static cilist io___454 = { 0, 0, 0, fmt_330, 0 };
    static cilist io___455 = { 0, 0, 0, fmt_350, 0 };
...
/*     ***  simple test program for smsno, sumsl, and humsl  *** */
...
/* Main program */ int MAIN__(void)
{
    ...
    static integer liv = 60;
    static integer lv = 150;

    /* Format strings */
    static char fmt_20[] = "(/\002 smsno on qdrtf \002)";
    static char fmt_40[] = "(/\002 sumsl on qdrtf \002)";
    static char fmt_70[] = "(/\002 humsl on qdrtf \002)";
    static char fmt_80[] = "(/\002 humsl updating d \002)";
    ...
    static integer i__;
    static doublereal v[150], x[4];
    static integer iv[60], uip[1];
    static doublereal urp[12]	/* was [4][3] */;
    static integer nout;
    extern /* Subroutine */ int deflt_(integer *, integer *, integer *, 
	    integer *, doublereal *), qdrtf_(), qdrtg_(), humsl_(integer *, 
	    doublereal *, doublereal *, S_fp, S_fp, integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, S_fp), smsno_(
	    integer *, doublereal *, doublereal *, S_fp, integer *, integer *,
	     integer *, doublereal *, integer *, doublereal *, S_fp), sumsl_(
	    integer *, doublereal *, doublereal *, S_fp, S_fp, integer *, 
	    integer *, integer *, doublereal *, integer *, doublereal *, S_fp)
	    ;
    extern integer imdcon_(integer *);
    extern /* Subroutine */ int qdrtgh_();

    /* Fortran I/O blocks */
    static cilist io___718 = { 0, 0, 0, fmt_20, 0 };
    static cilist io___722 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___723 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___724 = { 0, 0, 0, fmt_70, 0 };
    static cilist io___725 = { 0, 0, 0, fmt_80, 0 };



/* imdcon - supplies nout, the output unit number. */
/* qdrtf  - passed for calcf to smsno, sumsl, and humsl. */
/* qdrtg  - passed for calcg to sumsl. */
/* qdrtgh - passed for calcgh to humsl. */


/*  the length of  v  is dictated by humsl. */


/*  initialize nout, d, d1, and x. */
...
/*  arbitrarily pass qdrtf for ufparm to satifsy the calling sequence. */
    ...
    iv[0] = 0;
    smsno_(&c__4, d__, x, (S_fp)qdrtf_, iv, &liv, &lv, v, uip, urp, (S_fp)
	    qdrtf_);
...
/* L30: */
    ...
    */
    ...
    iv[0] = 12;
    sumsl_(&c__4, d__, x, (S_fp)qdrtf_, (S_fp)qdrtg_, iv, &liv, &lv, v, uip, 
	    urp, (S_fp)qdrtf_);
...
/*  and the final x and gradient should be affected. */
    ...
    for (i__ = 1; i__ <= 4; ++i__) {
	x[i__ - 1] = 0.;
	d__[i__ - 1] = pow_di(&c_b553, &i__);
	urp[i__ - 1] = d__[i__ - 1];
/* L50: */
    }
    io___723.ciunit = nout;
    /*
    s_wsfe(&io___723);
    e_wsfe();
    */
...
/* L60: */
    ...
    */
    ...
    iv[0] = 12;
    humsl_(&c__4, d__, x, (S_fp)qdrtf_, (S_fp)qdrtgh_, iv, &liv, &lv, v, uip, 
	    urp, (S_fp)qdrtf_);
...
/* Subroutine */ int qdrtf_(integer *n, doublereal *x, integer *nf, 
	doublereal *f, integer *uip, doublereal *urp, U_fp ufp)
{
    /* System generated locals */
    integer urp_dim1, urp_offset, i__1;
    ...
    /* Local variables */
    static integer i__;
    static doublereal t, f2, t1, dn;


/*  this routine evaluates the objective function f(x) described in the */
...
/* / */
    ...
    i__1 = *n;
    for (i__ = 1; i__ <= i__1; ++i__) {
	urp[i__ + (urp_dim1 << 1)] = urp[i__ + urp_dim1] * x[i__] - (real) 
		i__;
	t += urp[i__ + (urp_dim1 << 1)];
/* L10: */
    }
    f2 = 0.;
    i__1 = *n;
    for (i__ = 1; i__ <= i__1; ++i__) {
	t1 = dn * urp[i__ + (urp_dim1 << 1)] + t;
	f2 += t1 * urp[i__ + (urp_dim1 << 1)];
	urp[i__ + (urp_dim1 << 1)] = urp[i__ + urp_dim1] * t1;
/* L20: */
    }
    f2 = f2 * .5 + 1.;
    *f = sqrt(f2);
    urp[urp_dim1 * 3 + 1] = .5 / *f;
    urp[urp_dim1 * 3 + 2] = -.5 / (*f * f2);
/* L999: */
    return 0;
} /* qdrtf_ */
...
/* Subroutine */ int qdrtg_(integer *n, doublereal *x, integer *nf, 
	doublereal *g, integer *uip, doublereal *urp, S_fp qdrtf)
{
    /* System generated locals */
    integer urp_dim1, urp_offset, i__1;
...
/*  this routine evaluates the gradient of the objective function f(x) */
/*  described in the main program above.  see the comments there and in */
/*  subroutine qdrtf above. */
    ...
    /* Function Body */
    if (*nf != uip[1]) {
	(*qdrtf)(n, &x[1], nf, &f, &uip[1], &urp[urp_offset], (S_fp)qdrtf);
    }
    i__1 = *n;
    for (i__ = 1; i__ <= i__1; ++i__) {
/* L10: */
	g[i__] = urp[urp_dim1 * 3 + 1] * urp[i__ + (urp_dim1 << 1)];
    }
/* L999: */
    return 0;
} /* qdrtg_ */
...
/* Subroutine */ int qdrtgh_(integer *n, doublereal *x, integer *nf, 
	doublereal *g, doublereal *h__, integer *uip, doublereal *urp, S_fp 
	qdrtf)
{
    /* System generated locals */
    integer urp_dim1, urp_offset, i__1, i__2;

    /* Local variables */
    static doublereal f;
    static integer i__, j, k;
    static doublereal t1, t2, dn;


/*  this routine evaluates the gradient and hessian of the objective */
/*  function f(x) described in the main program above.  see the comments */
/*  there and in subroutine qdrtf above.  note that the  h  returned is */
...
/*     dimension h(n*(n+1)/2) */
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
	g[i__] = urp[urp_dim1 * 3 + 1] * urp[i__ + (urp_dim1 << 1)];
	t1 = urp[urp_dim1 * 3 + 1] * urp[i__ + urp_dim1];
	t2 = urp[i__ + (urp_dim1 << 1)] * urp[urp_dim1 * 3 + 2];
	i__2 = i__;
	for (j = 1; j <= i__2; ++j) {
	    ++k;
	    h__[k] = t2 * urp[j + (urp_dim1 << 1)] + t1 * urp[j + urp_dim1];
/* L10: */
	}
	h__[k] += dn * urp[i__ + urp_dim1] * t1;
/* L20: */
    }
/* L999: */
    return 0;
